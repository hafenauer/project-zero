...
def update_screen():
    ...
    draw_b.text((right_edge,-3), f"{cpu_temp}C", font=font_mono_tiny, fill=0, anchor="ra")

    draw_b.text((-1, 7), ip_addr, font=font_mono_tiny, fill=0)
    draw_b.text((right_edge,7), f"{signal}%", font=font_mono_tiny, fill=0, anchor="ra")
